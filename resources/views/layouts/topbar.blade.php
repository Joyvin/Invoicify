<header id="page-topbar">
    <div class="navbar-header">
        <div class="d-flex align-items-center">
            ...
            <!-- <div class="navbar-brand-box">
                <a href="{{url('index')}}" class="logo logo-dark">
                    <span class="logo-sm">
                        <img src="{{ URL::asset('/assets/images/logo-light-sm.svg') }}" alt="" height="36">
                    </span>
                    <span class="logo-lg">
        ...
        <div class="d-flex">
            ...
            <!-- App Search-->
            <form class="me-4 app-search d-none d-lg-block">
                <div class="position-relative border rounded-pill border-primary">

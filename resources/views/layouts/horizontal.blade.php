                    ...
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu mega-dropdown-menu px-2 dropdown-mega-menu-xl"
                                ...
                                <div class="row">
                                    <div class="col-lg-4">
                                        <div>
                                            <a href="#" class="dropdown-item">@lang('translation.Alerts')</a>
                                            <a href="#" class="dropdown-item">@lang('translation.Buttons')</a>
                                            <a href="#" class="dropdown-item">@lang('translation.Cards')</a>
                                            <a href="#" class="dropdown-item">@lang('translation.Carousel')</a>
                                            <a href="#" class="dropdown-item">@lang('translation.Dropdowns')</a>
                                            <a href="#" class="dropdown-item">@lang('translation.Grid')</a>
                                            <a href="#" class="dropdown-item">@lang('translation.Images')</a>
                                        </div>
                                    </div>
                                    <div class="col-lg-4">
                                        <div>
                                            <a href="#" class="dropdown-item">@lang('translation.Lightbox')</a>
                                            <a href="#" class="dropdown-item">@lang('translation.Modals')</a>
                                            <a href="#" class="dropdown-item">@lang('translation.Range_Slider')</a>
                                            <a href="#" class="dropdown-item">@lang('translation.Session_Timeout')</a>
                                            <a href="#" class="dropdown-item">@lang('translation.Progress_Bars')</a>
                                            <a href="#" class="dropdown-item">@lang('translation.Sweet_Alert')</a>
                                            <a href="#" class="dropdown-item">@lang('translation.Tabs_Accordions')</a>
                                        </div>
                                    </div>
                                    <div class="col-lg-4">
                                        <div>
                                            <a href="#" class="dropdown-item">@lang('translation.Typography')</a>
                                            <a href="#" class="dropdown-item">@lang('translation.Video')</a>
                                            <a href="#" class="dropdown-item">@lang('translation.General')</a>
                                            <a href="#" class="dropdown-item">@lang('translation.Colors')</a>
                                            <a href="#" class="dropdown-item">@lang('translation.Rating')</a>
                                            <a href="#" class="dropdown-item">@lang('translation.Notifications')</a>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="topnav-pages">
                                ...
                                <a href="#" class="dropdown-item">@lang('translation.Calendar')</a>
                                <a href="#" class="dropdown-item">@lang('translation.Chat')</a>
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="topnav-email">
                                        <a href="#" class="dropdown-item">@lang('translation.Inbox')</a>
                                        <a href="#" class="dropdown-item">@lang('translation.Read_Email')</a>
                                    </div>
                                </div>
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="topnav-ecommerce">
                                        <a href="#" class="dropdown-item">@lang('translation.Products')</a>
                                        <a href="#" class="dropdown-item">@lang('translation.Product_Detail')</a>
                                        <a href="#" class="dropdown-item">@lang('translation.Orders')</a>
                                        <a href="#" class="dropdown-item">@lang('translation.Customers')</a>
                                        <a href="#" class="dropdown-item">@lang('translation.Cart')</a>
                                        <a href="#" class="dropdown-item">@lang('translation.Checkout')</a>
                                        <a href="#" class="dropdown-item">@lang('translation.Shops')</a>
                                        <a href="#" class="dropdown-item">@lang('translation.Add_Product')</a>
                                    </div>
                                </div>
                                ...
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="topnav-invoice">
                                        <a href="#" class="dropdown-item">@lang('translation.Invoice_List')</a>
                                        <a href="#" class="dropdown-item">@lang('translation.Invoice_Detail')</a>
                                    </div>
                                </div>
                                ...
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="topnav-contact">
                                        <a href="#" class="dropdown-item">@lang('translation.User_Grid')</a>
                                        <a href="#" class="dropdown-item">@lang('translation.User_List')</a>
                                        <a href="#" class="dropdown-item">@lang('translation.Profile')</a>
                                    </div>
                                </div>
                            </div>
                        </li>
                            ...
                            <div class="dropdown-menu" aria-labelledby="topnav-components">
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="topnav-form">
                                        <a href="#" class="dropdown-item">@lang('translation.Basic_Elements')</a>
                                        <a href="#" class="dropdown-item">@lang('translation.Validation')</a></a>
                                        <a href="#" class="dropdown-item">@lang('translation.Advanced_Plugins')</a>
                                        <a href="#" class="dropdown-item">@lang('translation.Editors')</a>
                                        <a href="#" class="dropdown-item">@lang('translation.File_Upload')</a>
                                        <a href="#" class="dropdown-item">@lang('translation.Xeditable')</a>
                                        <a href="#" class="dropdown-item">@lang('translation.Repeater')</a>
                                        <a href="#" class="dropdown-item">@lang('translation.Wizard')</a>
                                        <a href="#" class="dropdown-item">@lang('translation.Mask')</a>
                                    </div>
                                </div>
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="topnav-table">
                                        <a href="#" class="dropdown-item">@lang('translation.Bootstrap_Basic')</a>
                                        <a href="#" class="dropdown-item">@lang('translation.Datatables')</a>
                                        <a href="#" class="dropdown-item">@lang('translation.Responsive')</a>
                                        <a href="#" class="dropdown-item">@lang('translation.Editable')</a>
                                    </div>
                                </div>
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="topnav-charts">
                                        <a href="#" class="dropdown-item">@lang('translation.Apex')</a>
                                        <a href="#" class="dropdown-item">@lang('translation.Chartjs')</a>
                                        <a href="#" class="dropdown-item">@lang('translation.Flot')</a>
                                        <a href="#" class="dropdown-item">@lang('translation.Jquery_Knob')</a>
                                        <a href="#" class="dropdown-item">@lang('translation.Sparkline')</a>
                                    </div>
                                </div>
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="topnav-icons">
                                        <a href="#" class="dropdown-item">@lang('translation.Unicons')</a>
                                        <a href="#" class="dropdown-item">@lang('translation.Boxicons')</a>
                                        <a href="#" class="dropdown-item">@lang('translation.Material_Design')</a>
                                        <a href="#" class="dropdown-item">@lang('translation.Dripicons')</a>
                                        <a href="#" class="dropdown-item">@lang('translation.Font_Awesome')</a>
                                    </div>
                                </div>
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="topnav-map">
                                        <a href="#" class="dropdown-item">@lang('translation.Google')</a>
                                        <a href="#" class="dropdown-item">@lang('translation.Vector')</a>
                                        <a href="#" class="dropdown-item">@lang('translation.Leaflet')</a>
                                    </div>
                                </div>
                            </div>
                        </li>
                            ...
                            <div class="dropdown-menu" aria-labelledby="topnav-more">
                                ...
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="topnav-auth">
                                        <a href="#" class="dropdown-item">@lang('translation.Login')</a>
                                        <a href="#" class="dropdown-item">@lang('translation.Register')</a>
                                        <a href="#" class="dropdown-item">@lang('translation.Recover_Password')</a>
                                        <a href="#" class="dropdown-item">@lang('translation.Lock_Screen')</a>
                                    </div>
                                </div>
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="topnav-utility">
                                        <a href="#" class="dropdown-item">@lang('translation.Starter_Page')</a>
                                        <a href="#" class="dropdown-item">@lang('translation.Maintenance')</a>
                                        <a href="#" class="dropdown-item">@lang('translation.Coming_Soon')</a>
                                        <a href="#" class="dropdown-item">@lang('translation.Timeline')</a>
                                        <a href="#" class="dropdown-item">@lang('translation.FAQs')</a>
                                        <a href="#" class="dropdown-item">@lang('translation.Pricing')</a>
                                        <a href="#" class="dropdown-item">@lang('translation.Error_404')</a>
                                        <a href="#" class="dropdown-item">@lang('translation.Error_500')</a>
                                    </div>
                                </div>
                            </div>
                        </li>
